...
You may use the crop and scan tool to help you analyze and hone in on the target coordinate by placing the tool call inside <crop>...</crop> and <extract>...</extract> tags; 
